...
public class ClientEventHandler {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (event.phase == TickEvent.Phase.END && mc.player != null) {
            if (KeyBindings.spectatorShortcut.consumeClick()) ServerPacket.instance.sendToServer(new SpectatorShortcutPacket());
            else if (KeyBindings.nightvisionShortcut.consumeClick()) ServerPacket.instance.sendToServer(new NightvisionShortcutPacket());
        }
    }
}
